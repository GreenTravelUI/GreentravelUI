...
function confirmAlert() {
    swal({
        title: "Are you sure want to create supplier as agent?",
        text: "You are going to create agent!",
        type: "warning",
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            swal("Created!", "Your agent has been created.", "success");

        } else {
            swal("Cancelled", "Your agent is cancelled :)", "error");
        }
    });
}
