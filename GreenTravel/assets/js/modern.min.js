    ...
    if ($(".small-sidebar .navbar .logo-box a span").html($(".navbar .logo-box a span").text() == p ? m : p), $(".theme-settings").length || $(".sidebar-toggle").click(function () {
    ...
    }), $("body").hasClass("page-sidebar-fixed") || 1 != i.checked || $("body").addClass("page-sidebar-fixed"), $("body").hasClass("page-sidebar-fixed") && 0 == i.checked && $(".fixed-sidebar-check").prop("checked", !0), $("body").hasClass("page-header-fixed") || 1 != t.checked || $("body").addClass("page-header-fixed"), $("body").hasClass("page-header-fixed") && 0 == t.checked && $(".fixed-header-check").prop("checked", !0), $("body").hasClass("page-horizontal-bar") || 1 != l.checked || ($("body").addClass("page-horizontal-bar"), $(".sidebar").addClass("horizontal-bar"), $(".sidebar").removeClass("page-sidebar")), $("body").hasClass("page-horizontal-bar") && 0 == l.checked && $(".horizontal-bar-check").prop("checked", !0), $("body").hasClass("small-sidebar") || 1 != r.checked || $("body").addClass("small-sidebar"), $("body").hasClass("small-sidebar") && 0 == r.checked && $(".horizontal-bar-check").prop("checked", !0), $(".page-content").hasClass("container") || 1 != d.checked || $(".toggle-sidebar-check").addClass("container"), $(".page-content").hasClass("container") && 0 == d.checked && $(".boxed-layout-check").prop("checked", !0), $(".page-content").hasClass("container") || 1 != d.checked || $(".toggle-sidebar-check").addClass("container"), $(".page-content").hasClass("container") && 0 == d.checked && $(".boxed-layout-check").prop("checked", !0), $(".page-content").hasClass("container") || 1 != d.checked || $(".toggle-sidebar-check").addClass("container"), $(".page-content").hasClass("container") && 0 == d.checked && $(".boxed-layout-check").prop("checked", !0)), $(".chat").length) {
        {
            var w = document.getElementById("cbp-spmenu-s1"),
                w1 = document.getElementById("cbp-rightsummary-s1"),
                w2 = document.getElementById("cbp-righttimeline-s2");
                w3 = document.getElementById("cbp-rightitinerary-s3");
                S = document.getElementById("showRight"), 
                S1 = document.getElementById("showRightSideSummary"),
                S2 = document.getElementById("showRightSideTimeline"),
                S3 = document.getElementById("showRightSideItinerary"),
                z = document.getElementById("closeRight"),
                z1 = document.getElementById("closeRightSideSummary"),
                z2 = document.getElementById("closeRightSideTimeline"), 
                z3 = document.getElementById("closeRightSideItinerary"),
        ...
        S.onclick = function () {
            ...
            classie.toggle(w1, "cbp-spmenu-open")
        }, S2.onclick = function () {
            classie.toggle(w2, "cbp-spmenu-open")
        }, S3.onclick = function () {
            classie.toggle(w3, "cbp-spmenu-open")
        }, z.onclick = function () {
            classie.toggle(w, "cbp-spmenu-open")
        }, z1.onclick = function () {
            classie.toggle(w1, "cbp-spmenu-open")
