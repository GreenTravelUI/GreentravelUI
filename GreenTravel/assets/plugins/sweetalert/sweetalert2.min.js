...
! function (e, t) {
    ...
    function n() {
        function n(t) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(o)) {
                for (var l = n.target || n.srcElement, i = -1, s = 0; s < x.length; s++)
                    if (l === x[s]) {
                        i = s;
                        break
                    }
        ...
        var g, p = function (t) {
            ...
            switch (n.type) {
                ...
                case "mousedown":
                    ...
                    break;
                case "click":
                    if (l && c.callback && i) c.callback(!0), c.closeOnConfirm && s();
                    else if (c.callback && i) {
                        if ("number" == typeof c.callback.length) d = Boolean(c.callback.length);
                        else var u = String(c.callback).replace(/\s/g, ""),
                            d = "function(" === u.substring(0, 9) && ")" !== u.substring(9, 10);
        ...
        var b = m.querySelector("button.confirm"),
            B = m.querySelector("button.cancel"),
            x = m.querySelectorAll("button, input:not([type=hidden]), textarea");
    ...
    function o(n) {
        ...
        var r = o.querySelector("h2"),
            i = o.querySelector("p"),
            s = o.querySelector("button.cancel"),
            c = o.querySelector("button.confirm"),
            u = o.querySelector("hr");
    ...
    var m, d, f, y, g = ".sweet-alert",
        p = ".sweet-overlay",
        v = "sweet-alert-mediaquery",
    ...
    e.sweetAlert = e.swal = function () {
        var e = arguments,
            t = h();
        if (null !== t) k(t, "visible") && c(), n.apply(this, e);
